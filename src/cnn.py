...
def prepare_data():
    ...
    train_data, test_data, train_label, test_label = train_test_split(
        pd_data['question_text'], pd_data['target'], test_size=0.2, shuffle=False)
    ...
    train_features, test_features = train_test_split(
        all_features, test_size=0.2, shuffle=False)
...
def fit_and_predict(load_test_data,
    ...
    for epoch in range(num_epochs):
        ...
        for my_train_data, my_train_features, my_train_labels in train_loader:
            optimizer.zero_grad()
            ...
            if iter % 100 == 0:
                ...
                for my_test_data, my_test_features, my_test_labels in test_loader:
                    ...
                    correct += (predicted_label == my_test_labels).sum()
