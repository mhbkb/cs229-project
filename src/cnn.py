...
def fit_and_predict(load_test_data,
    ...
    for epoch in range(num_epochs):
        ...
        train_loss = 0
        for my_train_data, my_train_features, my_train_labels in tqdm(train_loader, disable=False):
        ...
        if epoch >= 5:
            ...
            # import pdb; pdb.set_trace()
            print(
                f'accuracy is: {accuracy_score(test_label.values, all_predicted_label)}')
            print(
                f'f1 score is: {f1_score(test_label.values, all_predicted_label)}')
            print(
                f'confusion_matrix score is: {confusion_matrix(test_label.values, all_predicted_label)}')
